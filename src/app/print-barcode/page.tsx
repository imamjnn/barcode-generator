            ...
            {productSelected.map((item) => (
              ...
              >
                <div>
                  ...
                  {priceSelected[item.product_code].type}{" "}
                  {priceSelected[item.product_code].price}
                </div>
                <div className="flex items-center">
                  <select
                    className="select select-bordered w-full max-w-xs mr-20"
                  ...
                  <input
                    ...
                    placeholder="Jumlah"
                    className="input input-bordered w-[120px] mr-20"
